...
There are num, chr, Date are the data types. I used https://stackoverflow.com/questions/21125222/determine-the-data-types-of-a-data-frames-columns for help. 
...
With a p value of less than 2e^-16 there is significant evidence that not all the mean weights are the same between the fourteen rodent species.
